...
struct SoldierNPCMovementSM_Event_AIM : public PE::Events::Event {
	PE_DECLARE_CLASS(SoldierNPCMovementSM_Event_AIM);

	SoldierNPCMovementSM_Event_AIM()
	{}
...
struct SoldierNPCMovementSM : public PE::Components::Component
{
	...
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCMovementSM_Event_AIM)
	virtual void do_SoldierNPCMovementSM_Event_AIM(PE::Events::Event *pEvt);
	//
